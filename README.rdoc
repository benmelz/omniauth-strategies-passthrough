...
Within your omniauth initializer, include the passthrough strategy in development/test environments.
*NEVER* use this strategy in a production environment.

  Rails.application.config.middleware.use OmniAuth::Builder do
    ...
    provider :passthrough unless Rails.env.production?
    ...
  end
